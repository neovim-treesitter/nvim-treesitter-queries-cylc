# nvim-treesitter-queries-cylc

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-cylc/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-cylc/actions/workflows/validate.yml)

Neovim tree-sitter queries for **cylc**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-cylc",
...
- [ ] Changes are scoped to `cylc` — do not include files for other languages
